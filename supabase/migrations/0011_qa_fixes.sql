-- 0011_qa_fixes.sql
-- EXPERTOEN-QA FIXES (deleg_bb0e05d8, 20.08.):
-- R4-1: soft_delete_cascade muss auch Geodaten am Fang löschen (DPIA-Konformität)
-- E2-1: sync_catch muss species_custom mitsynchen (Offline-Sync-Verlust)

-- ============================================================
-- FIX 1: soft_delete_cascade — Geodaten am Fang löschen
-- (bestehende Funktion aus 0001 wird ersetzt)
-- ============================================================
...
BEGIN
  IF NEW.deleted_at IS NOT NULL AND OLD.deleted_at IS NULL THEN
    ...
    -- GEODATEN AM FANG LÖSCHEN (DPIA: lat/lng -> NULL, Recht auf Vergessen)
...
-- ============================================================
-- FIX 2: sync_catch — species_custom mitsynchen
-- ============================================================
...
COMMENT ON FUNCTION public.sync_catch(uuid, jsonb)
  IS 'Idempotenter Offline-Sync-Upsert: LWW via client_updated_at. Inkl. species_custom (QA-Fix 0011).';
